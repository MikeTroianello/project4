    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>At any point, if you want to start creating your own story page, press the <b>"Create a new Page!"</b> button a the bottom</li>
        </ul>
        <h3>Creating a new Page:</h3>
          <ul>
            <li>After pressing the <b>"Create a new Page!"</b> button, three text boxes will open up: the Title, Content, and Teaser</li>
            <li>The <strong>Title</strong> will be what is displayed towards the top of the page you are creating.</li>
            <li>The <strong>Content</strong> will be the events that you decide to write about. Be creative and have fun!</li>
            <li>The <strong>Teaser</strong> will be what is displayed on the previous page, as the link the next reader will see.</li>
