...
export default class StoryPage extends Component{
  ...
  componentDidMount(){
    ...
    //   //NEWLY ADDED
    //   Axios.get(`${SERVER_URL}/view-profile/${this.state.creatorId}`).then(userNameFromServer=>{
  ...
  render(){
    ...
    <h5>Created by <a href={`/view-profile/${this.state.story.creatorName}`}>{this.state.story.creatorName}</a></h5>
