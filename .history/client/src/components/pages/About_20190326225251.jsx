      ...
      <div>
        ...
        <h3>Creating a new Page:</h3>
          <ul>
            ...
            <li>The <strong>Teaser</strong> will be what is displayed on the previous page, as the link the next reader will see. (For example, if you want your story to be about what happens when you leave a room, your teaser would be something along the lines of "Leave the Room", so the next player will know what they are choosing)</li>
          </ul>
        </p>
      </div>
    )}
