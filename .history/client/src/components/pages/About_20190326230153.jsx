    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>At any point, if you want to start creating your own story page, press the "Create a new Page!" button a the bottom</li>
        </ul>
        <h3>Creating a new Page:</h3>
          <ul>
            <li>After pressing the "Create a new Page!" button, three text boxes will open up: the Title, Content, and Teaser</li>
