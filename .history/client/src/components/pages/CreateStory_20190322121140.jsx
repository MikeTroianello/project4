      ...
      <div className="CreateStory">
        ...
        <form onSubmit={this.handleSubmit}>
          ...
          Put the teaser for this route: <input 
            ...
            onChange={this.handleInputChange} 
            /> <br></br>
            <p>(The teaser is the link that will lead readers to this page you are creating.)</p><br></br>
            <p>(e.g. if your story is about goint to a city, the teaser could be "go to the city")</p>
